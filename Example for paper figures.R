...
correlation_heatmap(working.dir=analysis.dir, figure.dir=figure.dir,simul.data='Bottomly', nsample=5, topgenes=300, AnalysisMethods=AnalysisMethods, rep.end=50) #Draw correlation heatmap for DE methods run with Bottomly real data analysis
